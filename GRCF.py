...
from GRCFlibs.GRCFplotFunctions import *
...
generalInclinationEntry = Tk.Entry(generalPanel, textvariable=generalInclinationValue, width=5, state="disabled")
generalInclinationEntry.grid(column=1, row=0)
...
generalScaleEntry.grid(column=1, row=1)
...
generalSunMagEntry.grid(column=1, row=2)
...
bulgeEffSurfBriEntry.grid(column=1, row=1)
...
bulgeSersicIndexEntry.grid(column=1, row=2)
...
bulgeEffRadiusEntry.grid(column=1, row=3)
...
bulgeOblatenessEntry.grid(column=1, row=4)
Tk.Label(bulgePanel, text="M/L").grid(column=0, row=5)
bulgeMLratioValue = Tk.StringVar()
bulgeMLratioValue.set("4.00")
bulgeMLratioEntry = Tk.Entry(bulgePanel, textvariable=bulgeMLratioValue, width=5, state="disabled")
bulgeMLratioEntry.grid(column=1, row=5)
...
diskCenSurfBriEntry.grid(column=1, row=1)
...
diskExpScaleEntry.grid(column=1, row=2)
...
diskThicknessEntry.grid(column=1, row=3)
...
diskMLratioEntry = Tk.Entry(diskPanel, textvariable=diskMLratioValue, width=5, state="disabled")
diskMLratioEntry.grid(column=1, row=4)
